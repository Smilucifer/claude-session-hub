...
function extractCJKSegments(text) {
...
function extractCJKFromText(text, maxLen) {
...
function extractEnglishFromLines(lines, maxLen) {
...
function extractPreview(buffer, startIndex, maxLen = 150) {
...
class SessionManager {
  ...
  handlePromptSubmitHook(sessionId) {
    const session = this.sessions.get(sessionId);
    if (!session) return undefined;
